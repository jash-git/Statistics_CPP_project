...
class CStatistics
{
    public:
        ...
        static void calClassLimit(double* data,int number,double class_interval,double *class_limit_L,double *class_limit_U,double *class_mean,int *class_count,int number_of_class,double Minimum_unit);
